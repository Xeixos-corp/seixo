...
import installer from './NativeSignalNativeRn';
...
export * from './generated/signal_native';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as signal_native from './generated/signal_native';
...
if (!initialized) {
  signal_native.default.initialize();
  initialized = true;
}
